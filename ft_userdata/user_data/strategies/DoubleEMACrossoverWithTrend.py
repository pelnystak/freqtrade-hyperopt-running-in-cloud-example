...
class DoubleEMACrossoverWithTrend(IStrategy):
    ...
    > freqtrade download-data --timeframes 1h --timerange=20210301-20211215
    > freqtrade backtesting --export trades -s DoubleEMACrossoverWithTrend --timeframe 1h --timerange=20210301-20211215
    > freqtrade plot-dataframe -s DoubleEMACrossoverWithTrend --indicators1 ema200 --timeframe 1h --timerange=20210301-20211215
